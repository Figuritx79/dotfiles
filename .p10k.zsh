# Generated by Powerlevel10k configuration wizard on 2024-05-12 at 23:19 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND='#27272A'
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#ee0000'
  # Custom icon.
